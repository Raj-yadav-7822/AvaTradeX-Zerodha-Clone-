...
const ChargesExplained = () => {
  return (
<>
 <p className='text-center mt-4 fs-5'><span style={{color:"rgb(56, 126, 209",lineHeight:"22px"}}>
 Calculate your costs upfront    </span>using our brokerage calculator

</p>
<div className="container paragraph">
    <h4 className='md-mt-4'>Charges explained</h4>
    <div className="row mt-5">
        <div className="col-md-6 mb-4">
          ...
          <p> 
            When trading at AvaTradeX, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.</p> 
            ...
            <h6>Call & trade</h6>
            <p>Additional charges of ₹50 per order for orders placed through a dealer at AvaTradeX including auto square off orders.</p>
            <h6>Stamp charges</h6>
